# PHYS 2C Lecture Notes — Design Specification

This document is the **authoritative design guide** for lecture-note notebooks. It incorporates the former `guildline.md` (lecture-note structure and style). For broader curriculum and AI-era teaching philosophy, see [`teaching_philosophy.md`](teaching_philosophy.md).
